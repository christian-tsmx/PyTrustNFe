...
def _send(certificado, method, **kwargs):
    ...
    print("https://www.tributosmunicipais.com.br/nfse/api/?tokenAuth=" + kwargs["nfse"]["chave_digital"])
    request = requests.post("https://www.tributosmunicipais.com.br/nfse/api/?tokenAuth=" + kwargs["nfse"]["chave_digital"], data=soap, headers=headers)
